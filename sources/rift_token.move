...
module rift_token::rift_token {
    ...
    // Constants
    const CREATOR_ALLOCATION: u64 = 200_000_000_000_000_000; // 2% of total supply
    const POOL_ALLOCATION: u64 = 980_00_000_000_000_000_000; // 98% of total supply
    const DECIMALS: u8 = 9;
    ...
    fun init(witness: RIFT_TOKEN, ctx: &mut TxContext) {
        ...
        let (mut treasury_cap, metadata) = coin::create_currency(
            ...
            option::some(url::new_unsafe_from_bytes(b"https://harlequin-imperial-armadillo-412.mypinata.cloud/ipfs/bafkreih4mag7tt75x3lxxcgg6tx5wsitcdypqti3fvmdq6kyypcb5fieoy")), // Replace with actual token image URL
            ctx
        );
